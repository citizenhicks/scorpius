...
from config import MODEL_PATHS, MODEL_IDS, MODEL_CONFIGS, ModelConfig
...
def download_weights(model_id: str, out_dir: Optional[Path] = None):
    ...
    del hf_model
    del state_dict
    print(f"Weights downloaded for model: {model_id}")

def load_weights(model_id: str, device: str, ckpt_dir: Optional[Path] = None) -> ModelWeights:
